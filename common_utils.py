...
def scan_multiple_runs(base_dir='./MapReduceLog'):
    ...
    返回：
    - monitor_data: {dataset: {slowstart: [df1, df2, df3, ...]}}
    - stage_data: {dataset: {slowstart: [stage1, stage2, stage3, ...]}}
    """
...
def average_stage_data(stage_data):
    """
    将多轮 stage 数据平均
    返回: {dataset: {slowstart: averaged_stage_dict}}
    """
    averaged_stages = {}
